...
import lb6.*;
import lb6.Russian.RussianAtomikSubmarine;
import lb6.Russian.RussianDieselElectricSubmarines;
import lb6.Russian.RussianRescueboat;
import java.util.Random;
import java.util.ArrayList;

public class RussianShipFactory implements ShipFactory {
    private final Random random = new Random();
    @Override
    public AtomikSubmarineInterface getAtomikSubmarine() {
        return new RussianAtomikSubmarine(random.nextInt(150)+100,
    ...
    public DieselElectricSubmarineInterface getDieselElectricSubmarines() {
        return new RussianDieselElectricSubmarines(random.nextInt(80)+50,
    ...
    public RescueboatInterface getRescueboat() {
        return new RussianRescueboat(random.nextInt(20)+7,
